...
- SPECIAL RULE FOR AIRPORT CODES: "Madinah" / "Mohammad Bin Abdulaziz" airport is MED (Madinah, Saudi Arabia). Do NOT confuse it with AMM (Amman).
...
- "invalid_images": [
    {
      "image_name": "roof.jpg",
      "reason": "الصورة لا تظهر سقف السيارة، بل تظهر عجلة القيادة"
    }
  ], or null if all images are valid and correct.
